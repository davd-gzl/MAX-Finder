...
export const de: Dict = {
  ...
  view_list: "Liste",
  view_map: "Karte",
  results_filter: "Nach Stadt filtern…",
  results_sort: "Sortieren",
  results_more: "Mehr anzeigen",
  sort_relevance: "Relevanz",
  sort_fast: "Schnellste",
  sort_name: "Name (A–Z)",
  sort_depart: "Früheste Abfahrt",
