...
export const en: Dict = {
  ...
  mode_oneway: "One-way",
  mode_daytrip: "Day trip",
  mode_roundtrip: "Round trip",
  stay_label: "How long?",
  stay_oneway: "Just going",
  stay_sameday: "Same day",
  stay_n1: "1 night",
  stay_n2: "2",
  stay_n3: "3",
  stay_n2_aria: "2 nights",
  stay_n3_aria: "3 nights",
  ...
  daytrip_best_day: "Most time on site: {date} ({h}h)",
  res_day_title: "{origin} ⇄ {destination} · {date}",
  res_rt_title: "{origin} ⇄ {destination} · {out} → {ret}",
  rt_return_leg: "Return",
  daytrip_return_hint: "Later you leave, more time on site",
  daytrip_finder_title: "Where can you go for the day?",
  daytrip_finder_hint: "Ranked by hours on site",
  ...
  daytrip_none: "No same-day round trip to this city in this window.",
  rt_no_return: "No return day works in this window.",
  rt_return_moved: "Return moved to the first feasible day after your new outbound.",
  win_weekend: "This weekend",
  win_week: "Next 7 days",
  win_month: "This month",
  keys_roundtrip: "r: one-way / round trip",
  glossary_title: "Round trip vs Day trip",
