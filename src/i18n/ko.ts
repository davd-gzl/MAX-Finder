...
export const ko: Dict = {
  ...
  daytrip_title: "{station}에서 떠나는 당일치기 — {date}",
  daytrip_count: "당일치기 {n}곳 가능",
  daytrip_none: "이 조건으로 당일 MAX 왕복이 없습니다.",
  daytrip_none_hint: "환승을 늘리거나, 체류 시간을 줄이거나, 늦은 귀가를 허용해 보세요.",
