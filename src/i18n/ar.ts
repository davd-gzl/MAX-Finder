...
export const ar: Dict = {
  ...
  tab_ideas: "أفكار",
  desc_simple: "أدخل محطة المغادرة والوصول. اترك حقلاً فارغاً لاكتشاف الوجهات الممكنة.",
  desc_return: "رحلة ذهاب وإياب بين محطتين، بتاريخ ذهاب وتاريخ عودة.",
  desc_multi: "رحلة متعددة المدن تربط مقاعد MAX المجانية.",
  multi_plan: "خطّط جولة",
