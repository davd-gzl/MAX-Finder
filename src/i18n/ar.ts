...
export const ar: Dict = {
  ...
  ret_dates: "حسب التواريخ",
  ret_duration: "حسب المدة",
  opt_yes: "نعم",
  opt_no: "لا",
  field_depart: "الذهاب",
  field_ret: "العودة",
  ...
  desc_return_dates: "اختر ذهابك وعودتك؛ نعرض مقاعد MAX المجانية في الاتجاهين.",
  desc_return_duration: "أخبرنا كم تريد البقاء؛ نجد أيام الانطلاق المناسبة.",
  ...
  gw_more: "أوقات أخرى في ذلك اليوم ({n})",
  density_compact: "عرض مضغوط",
  density_comfortable: "عرض مريح",
  ...
  getaway_od_title: "ذهاب وإياب {origin} ← {destination} — {date}",
  ...
  daytrip_return_hint: "كلما تأخرت في العودة، زاد وقتك هناك",
  daytrip_finder_title: "إلى أين تذهب في رحلة يومية؟",
  daytrip_finder_hint: "مرتبة حسب ساعات المكوث",
  rt_finder_title: "إلى أين تهرب؟",
  rt_need_origin: "أضف نقطة انطلاق لمعرفة أين يمكنك الذهاب والعودة.",
  daytrip_none: "لا توجد رحلة يومية ذهاب وإياب إلى هذه المدينة في هذه الفترة.",
  rt_no_return: "لا يوجد يوم عودة ممكن في هذه الفترة.",
  rt_return_moved: "تم نقل العودة إلى أول يوم ممكن بعد ذهابك الجديد.",
  win_weekend: "نهاية هذا الأسبوع",
  win_week: "الأيام السبعة القادمة",
  win_month: "هذا الشهر",
  keys_roundtrip: "r: ذهاب / يومية / ذهاب وإياب",
  glossary_title: "ذهاب وإياب أم رحلة يومية؟",
