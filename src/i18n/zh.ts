...
export const zh: Dict = {
  ...
  desc_return_dates: "选择去程和返程日期；我们显示两个方向的免费 MAX 座位。",
  desc_return_duration: "告诉我们想停留多久；我们会找到可行的出发日期。",
  ...
  getaway_od_title: "往返 {origin} → {destination} — {date}",
  ...
  rt_return_leg: "返程",
  daytrip_return_hint: "返程越晚，当地停留越久",
  daytrip_finder_title: "当天可以去哪里？",
  daytrip_finder_hint: "按当地停留时间排序",
  rt_finder_title: "去哪里度假？",
  rt_need_origin: "填写出发地，即可查看可往返的目的地。",
  daytrip_none: "此时段内没有到该城市的当天往返。",
  rt_no_return: "此时段内没有可行的返程日。",
  rt_return_moved: "返程已改到新出发日之后第一个可行日。",
  win_weekend: "本周末",
  win_week: "未来 7 天",
  win_month: "本月",
  keys_roundtrip: "r：单程 / 当天往返 / 往返",
  glossary_title: "往返与当天往返",
