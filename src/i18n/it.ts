...
export const it: Dict = {
  ...
  desc_return_dates: "Scegli andata e ritorno; ti mostriamo i posti MAX gratuiti in entrambi i sensi.",
  desc_return_duration: "Dicci quanto vuoi restare; troviamo i giorni di partenza che funzionano.",
  ...
  getaway_od_title: "Andata e ritorno {origin} → {destination} — {date}",
  ...
  mode_daytrip: "Andata e ritorno in giornata",
  mode_roundtrip: "Andata e ritorno",
  stay_label: "Quanto tempo?",
  stay_oneway: "Solo andata",
  stay_sameday: "In giornata",
  stay_n1: "1 notte",
  stay_n2: "2",
  stay_n3: "3",
  stay_n2_aria: "2 notti",
  stay_n3_aria: "3 notti",
  ...
  mode_trip_label: "Tipo di viaggio",
  daytrip_cal_hours: "{h} h sul posto",
  cal_legend_hours: "numero = ore sul posto",
  cal_legend_nights: "numero = notti fuori",
  daytrip_best_day: "Più tempo sul posto: {date} ({h} h)",
  res_day_title: "{origin} ⇄ {destination} · {date}",
  res_rt_title: "{origin} ⇄ {destination} · {out} → {ret}",
  rt_return_leg: "Ritorno",
  daytrip_return_hint: "Più tardi riparti, più tempo sul posto",
  daytrip_finder_title: "Dove andare in giornata?",
  daytrip_finder_hint: "Ordinato per ore sul posto",
  rt_finder_title: "Dove evadere?",
  rt_need_origin: "Aggiungi una partenza per vedere dove andare e tornare.",
  daytrip_none: "Nessun andata e ritorno in giornata verso questa città nel periodo.",
  rt_no_return: "Nessun giorno di ritorno possibile nel periodo.",
  rt_return_moved: "Ritorno spostato al primo giorno possibile dopo la nuova andata.",
  win_weekend: "Questo weekend",
  win_week: "Prossimi 7 giorni",
  win_month: "Questo mese",
  keys_roundtrip: "r: solo andata / andata e ritorno",
  glossary_title: "Andata e ritorno o in giornata?",
